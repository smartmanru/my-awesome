...
- [FastEndpoints/Library](https://github.com/FastEndpoints/Library) - A light-weight REST Api framework for ASP.Net 6 that implements REPR (Request-Endpoint-Response) Pattern
